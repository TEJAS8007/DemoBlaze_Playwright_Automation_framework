...
export class Payment_Page {
    ...
    async verify_PaymentPage_Title(){
        ...
        console.log("Title Payment_Page : "+title);
            ...
            try {
              ...
              this.log.info('Payment Title Passed Succesfully...');
            } catch(error) {
              this.log.error('Payement Title not Passed Succesfully...');
            }
    }
    ...
    async verify_PaymentPage_Url(){
        ...
        console.log("Url Payment_Page : "+url);
            ...
            try {
              ...
              this.log.info('Payment Url Passed Succesfully...');
            } catch(error) {
              this.log.error('Payement url not Passed Succesfully...');
            }
    }
    ...
    try {
          ...
          this.log.info('Payemnt Product Name Validation Succesfull....');
        } catch (error) {
          this.log.error('Payemnt product Name validation not succesfull....');
        }
    ...
    async verify_Product_Price() {
      ...
      try {
            ...
            this.log.info('Payemnt Product Price Validation Succesfull....');
          } catch (error) {
            this.log.error('Payemnt Product Price validation not succesfull....');
          }
    ...
    async add_User_Info(na,co,ci,cr,mo,ye) {
        ...
        try {
              ...
              this.log.info('Payment name passed successfully...');
            } catch(error) {
              this.log.error('Payment name not passed...');
            }
        ...
        try {
              ...
              this.log.info('Payment country passed successfully...');
            } catch(error) {
              this.log.error('Payment country not passed...');
            }
        ...
        try {
              ...
              this.log.info('Payment city passed successfully...');
            } catch(error) {
              this.log.error('Payment city not passed...');
            }
        ...
        try {
              ...
              this.log.info('Payment CreditCard passed successfully...');
            } catch(error) {
              this.log.error('Payment CreditCard not passed...');
            }
        ...
        try {
              ...
              this.log.info('Payment Month passed successfully...');
            } catch(error) {
              this.log.error('Payment Month not passed...');
            }
        ...
        try {
              ...
              this.log.info('Payment Year passed successfully...');
            } catch(error) {
              this.log.error('Payment Year not passed...');
            }
